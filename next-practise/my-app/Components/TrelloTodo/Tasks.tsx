...
const Tasks = ({ task, listId, editTaskInList, handleTaskDelete, setDraggedTask }) => {
        ...
        <div className="flex justify-between">
            {isEditing ? (
                ...
                <li 
                    draggable
                    onDragStart={() =>
                        setDraggedTask({ taskId: task.taskId, sourceListId: listId })
                    } 
                    className="list-disc ml-2">{task.taskName}</li>
            )}
            <div>
